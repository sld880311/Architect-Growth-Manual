...
- [HotSpot虚拟机对象探秘](#hotspot虚拟机对象探秘)
  ...
  - [对象的内存布局](#对象的内存布局)
    - [对象头](#对象头)
      - [Markword](#markword)
      - [klass](#klass)
      - [数组长度（只有数组对象有）](#数组长度只有数组对象有)
      - [常用对象头结构](#常用对象头结构)
        - [普通对象](#普通对象)
        - [数组对象](#数组对象)
        - [其中 Mark Word 结构为](#其中-mark-word-结构为)
        - [64 位虚拟机 Mark Word](#64-位虚拟机-mark-word)
    - [实例数据](#实例数据)
  - [对象大小计算](#对象大小计算)
  - [对象的定位](#对象的定位)
    - [HotSpot对象模型](#hotspot对象模型)
...
![1590667814291.png](..\images\1590667814291.png)
...
![1590667874263.png](..\images\1590667874263.png)
...
![1590667902242.png](..\images\1590667902242.png)
...
![1590667923591.png](..\images\1590667923591.png)
